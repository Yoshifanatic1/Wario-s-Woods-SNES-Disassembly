; Note: Put your custom routine/data macros, references to them, and defines in this file from within the WW_InsertIntegratedPatches and WW_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro WW_InsertIntegratedPatches()
...
macro WW_ApplyPatchesPostAssembly()
