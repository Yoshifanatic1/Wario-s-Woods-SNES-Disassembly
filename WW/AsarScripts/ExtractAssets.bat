...
:Start
echo Place a headerless WW ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = WW (USA)
echo 1 = WW (PAL)
...
echo You need to place a WW ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
...
set StreamedBRRLoc="../SPC700/Samples/Streamed"
set ROMBit=$0001
goto :BeginExtract
...
if %PointerSet% equ 30 goto :MoveGlobalBRR
if %PointerSet% equ 36 goto :MoveStreamedBRR
goto :MoveNothing
